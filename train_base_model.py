...
parser.add_argument("--input_shape", '-sh', help="input shape: height, width",nargs=2, type=int, default=[224, 224])
...
def main():
    ...
    model = make_base_model(img_height, img_width, num_classes, batch_size)
    ...
    weights_file = f'{data_path}/weights/base_model.weights.h5'
